...
;
;
const dbPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["resolve"])("../../databaase.sqlite");
...
async function GET(req, res) {
    const users = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("SELECT * FROM Users").all();
    res.status(200).json(users);
}
async function POST(req, res) {
    const { username, email } = req.body;
    const result = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('INSERT INTO Users (username, email) VALUES (?, ?)').run(username, email);
    res.status(201).json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9b7d6a._.js.map